<div class="bg-gray-100 p-5 mt-10 flex flex-col justify-center items-center">
    ...
    @if (session()->has('mensaje'))
        <p class="border border-green-600 bg-green-100 text-green-600 font-bold p-2 my-5 text-sm rounded-lg">
            {{session('mensaje')}}
        </p>
    @else
        <form wire:submit.prevent='postularme' class="w-96 mt-5">
            <div class="mb-4">
                ...
                <x-text-input id="cv" wire:model='cv' type="file" accept=".pdf" class="block mt-1 w-full"></x-text-input>
            </div>
